		...
		<div id="header-slider" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3900">
			...
			<div class="carousel-inner">
				...
				for ( $i = 0; $i < 4; $i++ ) :
					...
					?>
				<div
					class="carousel-item <?php echo esc_html( 'carousel-item-' . $i ); ?> <?php echo esc_html( 0 === $i ? 'active' : '' ); ?>">
					<div class="carousel-wrap">
						...
						.carousel-item-<?php echo esc_html( $i ); ?>{
							background-image: url(<?php echo esc_url( wp_get_attachment_url( get_post_thumbnail_id( get_theme_mod( 'newsmandu_slider_post_' . $i ) ) ) ); ?>);
							height: 750px;
						}
