 ...
 */
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'ad_setting1',
			array(
				'label'       => __( 'Advertisement Area For Header Section', 'newsmandu' ),
				'description' => __( 'Enter your adverstisement script hear, which will display at frontpage header section.', 'newsmandu' ),
				'section'     => 'ad_section',
				'type'        => 'textarea',
			)
		)
