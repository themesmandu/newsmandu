...
<form class="form my-2 my-md-0" method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	...
	<i class="fas fa-times close-icon"></i>
		<input class="field form-control" id="s" name="s" type="text" placeholder="<?php esc_attr_e( 'Search &hellip;', 'newsmandu-magizine' ); ?>" value="<?php the_search_query(); ?>">
		<button class="submit btn-uni" id="searchsubmit" name="submit" type="submit" value="<?php esc_attr_e( 'Search', 'newsmandu-magizine' ); ?>"><i class="fas fa-search"></i></button>
	</div>
</form> 
</div>
